 ...
 */
package com.application.pidev.Controller.User;

import com.application.pidev.UserSettings.event.OnGenerateResetLinkEvent;
import com.application.pidev.UserSettings.event.OnRegenerateEmailVerificationEvent;
import com.application.pidev.UserSettings.event.OnUserAccountChangeEvent;
import com.application.pidev.UserSettings.event.OnUserRegistrationCompleteEvent;
import com.application.pidev.UserSettings.exception.InvalidTokenRequestException;
import com.application.pidev.UserSettings.exception.PasswordResetException;
import com.application.pidev.UserSettings.exception.PasswordResetLinkException;
import com.application.pidev.UserSettings.exception.TokenRefreshException;
import com.application.pidev.UserSettings.exception.UserLoginException;
import com.application.pidev.UserSettings.exception.UserRegistrationException;
import com.application.pidev.Entity.User.CustomUserDetails;
import com.application.pidev.Entity.User.payload.ApiResponse;
import com.application.pidev.Entity.User.payload.JwtAuthenticationResponse;
import com.application.pidev.Entity.User.payload.LoginRequest;
import com.application.pidev.Entity.User.payload.PasswordResetLinkRequest;
import com.application.pidev.Entity.User.payload.PasswordResetRequest;
import com.application.pidev.Entity.User.payload.RegistrationRequest;
import com.application.pidev.Entity.User.payload.TokenRefreshRequest;
import com.application.pidev.Entity.User.token.EmailVerificationToken;
import com.application.pidev.Entity.User.token.RefreshToken;
import com.application.pidev.UserSettings.security.JwtTokenProvider;
import com.application.pidev.Service.User.AuthService;
