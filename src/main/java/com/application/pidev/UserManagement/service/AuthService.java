...
package com.application.pidev.UserManagement.service;

import com.application.pidev.UserManagement.exception.PasswordResetLinkException;
import com.application.pidev.UserManagement.exception.ResourceAlreadyInUseException;
import com.application.pidev.UserManagement.exception.ResourceNotFoundException;
...
import com.application.pidev.UserManagement.model.PasswordResetToken;
import com.application.pidev.UserManagement.model.User;
import com.application.pidev.UserManagement.model.UserDevice;
...
public class AuthService {
     ...
     */
    public Optional<User> disableAccount(CustomUserDetails customUserDetails) {
        String email = customUserDetails.getEmail();
        User currentUser = userService.findByEmail(email)
                .orElseThrow(() -> new UpdatePasswordException(email, "No matching user found"));
